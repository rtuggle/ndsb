"""
Created on Mon Dec 29 17:37:30 2014

@author: stevenflinchbaugh
"""
...
os.chdir('/Users/stevenflinchbaugh/workspace')

import warnings
warnings.filterwarnings("ignore")

# get the classnames from the directory structure
directory_names = list(set(glob.glob(os.path.join("dataScienceBowl","train", "*"))).difference(set(glob.glob(os.path.join("dataScienceBowl","train","*.*")))))
...
# NEED TO CHECK INDICES OR HOW FILES ARE SORTED
...
# compare distributions of ratio   
...
# see our rough competition score
